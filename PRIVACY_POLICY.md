...
**Sunucuda (hesabınız için):** ad, e-posta adresi, hesap kimliği ve oturum bilgileri. Bu veriler yalnızca giriş yapmanızı sağlamak için kullanılır; satılmaz, reklam veya profilleme amacıyla kullanılmaz ve üçüncü taraflarla paylaşılmaz (yalnızca hizmeti sağlayan altyapı sağlayıcıları Supabase ve Google tarafından bizim adımıza işlenir).
...
- **Biyometri (`USE_BIOMETRIC`):** Uygulama kilidini parmak izi ile açmak için. Biyometrik veriniz uygulamaya hiç ulaşmaz; doğrulamayı telefonun işletim sistemi yapar.
...
- **Kamera, Mikrofon ve Konum:** Uygulama bu izinleri **talep etmez**.
